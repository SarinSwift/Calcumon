...
class ViewController: UICollectionViewController {
    ...
    let categories = ["Basic Math", "Addition", "Subtraction", "Multiplication", "Division", "Addition & Subtraction", "Division & Mulitplication", "Square Root", "Linear Equation", "Discontinuities", "Derivatives", "• Linear Algebra", "Vectors", "Matrices", "• Statistics", "Lists"]
